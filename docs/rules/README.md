...
| [`GHA-CACHE006`](GHA-CACHE006-setup-python-pip-cache-missing.md) | Detects `actions/setup-python` without pip dependency caching when Python installs are present. |
